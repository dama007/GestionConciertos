...
public class AltaConcierto extends javax.swing.JDialog {
    ...
    private Concierto nuevoConcierto;
    ...
    public void setNuevoConcierto(Concierto nuevoConcierto) {
        this.nuevoConcierto = nuevoConcierto;
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---Escoge una ciudad---", "Barcelona ", "Madrid", "Valladolid", "Sevilla", "Palma de Mallorca", "Las Palmas de Gran Canaria", "Bilbao", "Segovia", "Galicia", "Girona", "Lérida", "Zaragoza", "Almeria", "Huesca", "Huelva", " " }));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${nuevoConcierto.ciudad}"), jComboBox1, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jSpinner2, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Introduce un cantante, por favor.");
        } else if (jTextField2.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Introduce el recinto, por favor.");
        } else if (jComboBox1.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(this, "Escoge una ciudad, por favor.");
        } else {
            BcnSummerMusic.misConciertos.altaConcierto(nuevoConcierto);
            BcnSummerMusic.ficheroConciertos.grabar(BcnSummerMusic.misConciertos);
            JOptionPane.showMessageDialog(this, "Ole, ole, Concierto dado de alta.");
            dispose();
        }
