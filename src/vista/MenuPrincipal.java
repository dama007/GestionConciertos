...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Conciertos");
        jMenu1.setPreferredSize(new java.awt.Dimension(150, 19));

        jMenuItem1.setText("Alta Concierto");
        ...
        jMenuItem5.setText("Venta de entradas");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        AltaConcierto ac = new AltaConcierto(this, true);
        ac.setLocationRelativeTo(null);
        ac.setVisible(true);
    }//GEN-LAST:event_jMenuItem1ActionPerformed

    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        AltaCliente acl = new AltaCliente(this, true);
